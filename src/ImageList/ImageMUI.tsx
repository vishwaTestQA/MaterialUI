...
const ImageMUI = () => {
  return (
    <div>
      ...
      <ImageList sx={{height:"inherit"}} cols={3} rowHeight={150}>
            {
                imageData.map((img) => {
      ...
      <Box >
      <ImageList variant='masonry' sx={{width:"300px", height: "500px"}} cols={3} rowHeight={150}>
            {
                imageData.map((img) => {
                 return <ImageListItem>   
                  <img 
            ...
            <ImageList variant='quilted' sx={{width:"300px", height: "500px"}} cols={3} rowHeight={120}>
            {
                imageData.map((img) => {
                 return <ImageListItem>   
                  <img 
